...
-- district_food_risk: 行政區食安風險指數（用於 district_food_risk 圖表）
...
('大安區', 62.50, 8, 1250, 20, 1.60),
('信義區', 58.30, 7, 980, 18, 1.84),
('中山區', 54.20, 6, 1100, 17, 1.55),
('內湖區', 50.10, 6, 920, 15, 1.63),
('士林區', 48.70, 5, 870, 13, 1.49),
('文山區', 45.20, 5, 810, 12, 1.48),
('松山區', 43.80, 4, 760, 10, 1.32),
('北投區', 41.50, 4, 690, 9, 1.30),
('中正區', 38.90, 4, 720, 8, 1.11),
('南港區', 36.40, 3, 580, 7, 1.21),
('大同區', 34.20, 3, 540, 6, 1.11),
('萬華區', 32.10, 3, 620, 5, 0.81);
